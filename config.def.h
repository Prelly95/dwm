...
static const int user_bh = 0;           /* 0 means har height is dependent on font*/
static const char *fonts[] = {
    // "NotoSansMonoBold:size=20:antialias=true:autohint=true",
    "FontAwesome:size=20:antialias=true:autohint=true",
    "LiberationMono:size=20:antialias=true",
};
...
static const Rule rules[] = {
    ...
    {"kolourpaint",     "kolourpaint",                          NULL,                                                      0,              1,              1,              -1},
    {"spi_control",     "spi_control",                          NULL,                                                      0,              1,              1,              -1},
    {"Google-chrome",   "crx_nngceckbapebfimnlniiiahkandclblb", NULL,                                                      0,              1,              1,              -1},
    {"Google-chrome",   "google-chrome",                        "Sign in – Google Accounts - Google Chrome",               0,              1,              1,              -1},
    {"librepods",       "librepods",                            NULL,                                                      0,              1,              1,              -1},
};
...
static Key keys[] = {
    ...
    {MODKEY | ControlMask, KC_comma, inctag, {.i = -1}},
    {MODKEY | ControlMask, KC_period, inctag, {.i = +1}},
    {MODKEY | ShiftMask, KC_r, quit, {1}},
    {MODKEY, KC_r, refreshmon, {0}},
    {MODKEY | ShiftMask, KC_l, spawn, SHCMD("slock")},
    {MODKEY, KC_s, spawn, SHCMD("/home/patrick/Tools/scripts/screenshot.sh")},
    {MODKEY, KC_w, spawn, SHCMD("/home/patrick/Tools/scripts/chrome-profile.sh")},
    {MODKEY, KC_g, spawn, SHCMD("/home/patrick/Tools/scripts/grab_colour.sh")},
    {MODKEY | ShiftMask, KC_d, spawn, SHCMD("/home/patrick/Tools/scripts/init_displays.sh")},
    {MODKEY | ShiftMask, KC_b, spawn, SHCMD("alacritty -T blugo --class BLUGO -e blugo")},
    {0, KC_mon_brightness_up, spawn, SHCMD("/home/patrick/Tools/scripts/brightness +")},
    {0, KC_mon_brightness_down, spawn, SHCMD("/home/patrick/Tools/scripts/brightness -")},
    {0, KC_audio_raise_volume, spawn, SHCMD("/home/patrick/Tools/scripts/volumectl +5%")},
    {0, KC_audio_lower_volume, spawn, SHCMD("/home/patrick/Tools/scripts/volumectl -5%")},
    {0, KC_audio_mute, spawn, SHCMD("/home/patrick/Tools/scripts/volumectl toggle")},
...
static Button buttons[] = {
    ...
    {ClkRootWin, MODKEY, Button7, spawn, SHCMD("/home/patrick/Tools/scripts/volumectl -5%")},
    {ClkClientWin, MODKEY, Button7, spawn, SHCMD("/home/patrick/Tools/scripts/volumectl -5%")},
    {ClkRootWin, MODKEY, Button6, spawn, SHCMD("/home/patrick/Tools/scripts/volumectl +5%")},
    {ClkClientWin, MODKEY, Button6, spawn, SHCMD("/home/patrick/Tools/scripts/volumectl +5%")},
};
