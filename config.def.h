...
#define TAGKEYS(KEY,TAG) \
	...
	{ MODKEY|Mod1Mask,				KEY,	tagview,		{.ui = 1 << TAG} },
...
static char vol_up[] = "amixer set Master 3+; kill -44 $(pidof dwmblocks)";
static char vol_down[] = "amixer set Master 3-; kill -44 $(pidof dwmblocks)";
static char vol_mute[] = "amixer set Master toggle; kill -44 $(pidof dwmblocks)";
...
static Key keys[] = {
	...
	//Volume control
	{ MODKEY,                       XK_F11,    spawn,          SHCMD(vol_up) },
	{ MODKEY,                       XK_F10,    spawn,          SHCMD(vol_down) },
	{ MODKEY,                       XK_F9,     spawn,          SHCMD(vol_mute) },
